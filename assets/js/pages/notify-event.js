                    ...
                    beforeOpen: function(notice) {
                        ...
                        var timer = setInterval(function() {
                            ...
                            if (curValue > 115) {
                                ...
                                $(".trumbowyg-editor")[0].innerHTML = "<p>Xin chào!</p><p><strong></strong><strong><em><strong><strong></strong><strong></strong></strong><strong></strong><strong></strong><strong></strong></em></strong><strong></strong><strong></strong>Đây là phiên bản <strong>giao diện</strong> của phần mềm nhận dạng giọng nói <em>Tiếng Việt</em>.&nbsp;</p><p><em><strong>API</strong> sẽ được kết nối sau.</em></p><p>Xin cảm ơn ^^!<br></p>"
                                return;
                            }
                            curValue += plus;
                            progress.width(curValue + '%').attr('aria-valuenow', curValue);
