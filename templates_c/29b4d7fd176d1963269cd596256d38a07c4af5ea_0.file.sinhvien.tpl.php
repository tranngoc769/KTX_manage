<?php
/* Smarty version 3.1.36, created on 2020-12-15 14:11:58
  from 'G:\QL_KTX\templates\sinhvien.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5fd8b61e8099e6_50356485',
...
function content_5fd8b61e8099e6_50356485 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
">
                                                    <table id="usertable" class="table table-center mb-0 dataTable no-footer" role="grid" aria-describedby="usertable_info">
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting_asc" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 177.102px;">Tên</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 133.466px;">Phòng</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 179.83px;">MSSV</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 209.83px;">Ngày Sinh</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 209.83px;">Quê Quán</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 79.8295px;">SDT</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 79.8295px;">Mã Lớp</th>
                                                                ...
                                                                <td class="sorting_1">
                                                                    <div class="media">
                                                                        <div class="media-body ml-3 align-self-center">
                                                                            <p class="mb-0"><?php echo $_smarty_tpl->tpl_vars['sinhvien']->value->hoten;?>
</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
