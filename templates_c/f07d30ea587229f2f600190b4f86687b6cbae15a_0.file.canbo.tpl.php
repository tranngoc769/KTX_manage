<?php
/* Smarty version 3.1.36, created on 2020-12-15 14:19:28
  from 'G:\QL_KTX\templates\canbo.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5fd8b7e0e01ac8_82134445',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f07d30ea587229f2f600190b4f86687b6cbae15a' => 
    array (
      0 => 'G:\\QL_KTX\\templates\\canbo.tpl',
      1 => 1608038359,
      2 => 'file',
    ),
  ),
...
function content_5fd8b7e0e01ac8_82134445 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-6 d-flex align-items-center mb-4">
                            <h1 class="d-inline-block font-weight-normal mb-0">Quản lý cán bộ</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
...
">
                                                    <table id="usertable" class="table table-center mb-0 dataTable no-footer" role="grid" aria-describedby="usertable_info">
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting_asc" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 177.102px;">Mã cán bộ</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 133.466px;">Tên Cán Bộ</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 179.83px;">Quê Quán</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 79.8295px;">SDT</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 79.8295px;">Giới Tính</th>
                                                                <th class="sorting" tabindex="0" aria-controls="usertable" rowspan="1" colspan="1" style="width: 79.8295px;">Thao Tác</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                          <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['dsCanBo']->value, 'canbo');
                                                                ...
                                                                <td class="sorting_1">
                                                                    <div class="media">
                                                                        <div class="media-body ml-3 align-self-center">
                                                                            <p class="mb-0"><?php echo $_smarty_tpl->tpl_vars['canbo']->value->macb;?>
</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td><?php echo $_smarty_tpl->tpl_vars['canbo']->value->tencb;?>
</td>
                                                                <td><?php echo $_smarty_tpl->tpl_vars['canbo']->value->quequan;?>
</td>
                                                                <td><?php echo $_smarty_tpl->tpl_vars['canbo']->value->dienthoai;?>
</td>
                                                                <td><?php echo $_smarty_tpl->tpl_vars['canbo']->value->gioitinh;?>
</td>
                                                                <td class="text-right">
